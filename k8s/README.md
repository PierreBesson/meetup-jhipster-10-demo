...
```
$ docker image tag booking pbesson/booking
$ docker push pbesson/booking
$ docker image tag catalog pbesson/catalog
$ docker push pbesson/catalog
$ docker image tag gateway pbesson/gateway
$ docker push pbesson/gateway
```
